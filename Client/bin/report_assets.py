...
def update_test(data):
	...
	try:
		...
		message = "发送失败"
		print("\033[31;1m发送失败,{}\033[0m".format(e))
        ...
        "physical_disk_driver": [
            {
                "iface_type": "unknown",
                "slot": 0,
                "sn": "1357964130423230343234362021202020202020",
            ...
            },
            {
                "iface_type": "SATA",
                "slot": 1,
                "sn": "135796413042323023234362020102020202020",
                "model": "KINGSTON SV100S264G ATA Device",
                "manufacturer": "(标准磁盘驱动器)",
                "capacity": 2048
            },
